  ...
  files.push(
    {
      ...
      format: 'vue', // 文件格式
      style: 'css',
      handlebars: fileName + '.create.vue' // 模板名字
    },
    {
      fileName: fileName,
      options: options,
